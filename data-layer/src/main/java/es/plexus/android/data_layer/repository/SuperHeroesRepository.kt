...
class SuperHeroesRepository(
    ...
    override suspend fun fetchSuperHeroDetailData(id: Int): Either<FailureBo, Boolean> =
        remoteDataSource.fetchSuperHeroDetailData(id).flatMap { data ->
            saveSuperHeroesDetailData(data)
        }
    ...
    override suspend fun getSuperHeroesDetailPersistedData(id: Int): Either<FailureBo, SuperHeroesDataBo> =
